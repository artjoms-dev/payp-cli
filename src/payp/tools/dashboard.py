    ...
    async def call(self, args: dict[str, Any], context: dict[str, Any]) -> ToolResult:
        ...
        for idx, p in enumerate(panels_in):
            ...
            try:
                ...
                import logging
                logging.getLogger("payp.tools.dashboard").exception("DashboardTool query failed")
                rendered.append({
                    "title": p_title,
            ...
            try:
                ...
                import logging
                logging.getLogger("payp.tools.dashboard").exception("DashboardTool render failed")
        ...
        try:
            ...
            import logging
            logging.getLogger("payp.tools.dashboard").exception("DashboardTool TUI launch failed")
            return ToolResult(
                success=False,
